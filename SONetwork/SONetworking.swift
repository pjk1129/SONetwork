...
class SONetworking: NSObject {
    ...
    class func request( _ method : String = "GET", url : String , parameters : Dictionary<String,AnyObject> = [:], success : @escaping (_ result : String?)->Void, fail:@escaping (_ error : NSError?)->Void){
